...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Happy anniversary my love. Today I just want to thank you for being part of my life." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "1st anniversary" },
      { property: "og:description", content: "Happy anniversary my love. Today I just want to thank you for being part of my life." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "1st anniversary" },
      { name: "twitter:description", content: "Happy anniversary my love. Today I just want to thank you for being part of my life." },
